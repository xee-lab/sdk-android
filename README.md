...
```gradle
dependencies {
	compile 'com.github.xee-lab.sdk-android:sdk-core:4.1.7'
	compile 'com.github.xee-lab.sdk-android:sdk-api:4.1.'
}
```
...
```groovy
compile 'com.github.xee-lab.sdk-android:sdk-api:4.1.7'
